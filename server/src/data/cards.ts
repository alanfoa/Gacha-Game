...
export const cards: Card[] = [
  ...
  // l02
  { id: 'l02', name: 'Sukuna (Rey de las Maldiciones)', anime: 'Jujutsu Kaisen', rarity: Rarity.Legendary, stats: S(84, 66, 88, 20, 135), hp: 250, maxMana: 130, element: Element.Shadow,
  ...
  // l03
  { id: 'l03', name: 'Rudeus Greyrat (Dios de la Magia)', anime: 'Mushoku Tensei', rarity: Rarity.Legendary, stats: S(68, 60, 100, 20, 100), hp: 248, maxMana: 130, element: Element.Water,
  ...
  // l04
  { id: 'l04', name: 'Naruto (Modo Sabio 6 Caminos)', anime: 'Naruto', rarity: Rarity.Legendary, stats: S(82, 72, 78, 22, 120), hp: 255, maxMana: 130, element: Element.Light,
  ...
  // l07
  { id: 'l07', name: 'Tanjiro (Marca del Cazador)', anime: 'Demon Slayer', rarity: Rarity.Legendary, stats: S(82, 68, 70, 22, 115), hp: 250, maxMana: 130, element: Element.Fire,
  ...
  // l09
  { id: 'l09', name: 'Joseph Joestar (Maestro Supremo)', anime: "JoJo's", rarity: Rarity.Legendary, stats: S(72, 64, 80, 30, 110), hp: 240, maxMana: 130, element: Element.Light,
  ...
  // l11
  { id: 'l11', name: 'Killua (Modo Velocidad de Dios)', anime: 'Hunter x Hunter', rarity: Rarity.Legendary, stats: S(76, 60, 72, 22, 140), hp: 238, maxMana: 130, element: Element.Wind,
  ...
  // l13
  { id: 'l13', name: 'Yu Narukami (Izanagi-no-Okami)', anime: 'Persona 4', rarity: Rarity.Legendary, stats: S(74, 64, 92, 22, 112), hp: 245, maxMana: 130, element: Element.Light,
  ...
  // l16
  { id: 'l16', name: 'L Lawliet (Estratega Global)', anime: 'Death Note', rarity: Rarity.Legendary, stats: S(52, 52, 94, 36, 110), hp: 235, maxMana: 130, element: Element.Light,
  ...
  // l17
  { id: 'l17', name: 'Aqua Hoshino (Actor del Método Oscuro)', anime: 'Oshi no Ko', rarity: Rarity.Legendary, stats: S(70, 60, 82, 28, 112), hp: 240, maxMana: 130, element: Element.Shadow,
  ...
  // l18
  { id: 'l18', name: 'Ruby Hoshino (La Idol de la Nueva Era)', anime: 'Oshi no Ko', rarity: Rarity.Legendary, stats: S(64, 56, 88, 30, 108), hp: 238, maxMana: 130, element: Element.Light,
  ...
  // l19
  { id: 'l19', name: 'Natsu Dragneel (Modo Dragón de Fuego Negro)', anime: 'Fairy Tail', rarity: Rarity.Legendary, stats: S(88, 66, 74, 18, 120), hp: 260, maxMana: 130, element: Element.Fire,
  ...
  // l20
  { id: 'l20', name: 'Izuku Midoriya (Deku: 100% Full Cowl)', anime: 'My Hero Academia', rarity: Rarity.Legendary, stats: S(86, 68, 56, 22, 130), hp: 252, maxMana: 130, element: Element.Light,
  ...
  // l21
  { id: 'l21', name: 'Ken Kaneki (Kakuja Completo: Dragón)', anime: 'Tokyo Ghoul', rarity: Rarity.Legendary, stats: S(82, 64, 76, 20, 112), hp: 255, maxMana: 130, element: Element.Shadow,
